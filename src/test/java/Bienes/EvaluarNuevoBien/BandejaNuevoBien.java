...
public class BandejaNuevoBien {
	
	public void tareaBienTentativo(WebDriver driver, WebDriverWait wait, String cotizacion) throws InterruptedException{    
	    
		/*             Acceso a la tarea Evaluar Nuevo Bien         */
	    ...
	    waitCuore.repited(driver, wait);
	    wait.until(ExpectedConditions.elementToBeClickable(By.id("Evaluar_Nuevo_Bien")));
	    waitCuore.repited(driver, wait);
	    driver.findElement(By.xpath("//*[contains(text(),'Pendientes:')]")).click();
	    driver.findElement(By.id("Evaluar_Nuevo_Bien")).click();
	    Thread.sleep(1000);
		waitCuore.repited(driver, wait);
