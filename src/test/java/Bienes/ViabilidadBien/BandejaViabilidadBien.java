...
public class BandejaViabilidadBien {
	
	public void bandejaViabilidadBien(WebDriver driver, WebDriverWait wait, String version) throws InterruptedException{    
	    ...
	    Thread.sleep(1000);
	    waitCuore.repited(driver, wait);
	    wait.until(ExpectedConditions.elementToBeClickable(By.id("Analizar_Viabilidad_del_Bien")));
	    driver.findElement(By.id("Analizar_Viabilidad_del_Bien")).click();
	    Thread.sleep(1000);
		waitCuore.repited(driver, wait);
