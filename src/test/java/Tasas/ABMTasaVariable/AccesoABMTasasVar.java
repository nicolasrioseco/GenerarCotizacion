...
public class AccesoABMTasasVar {
	
	public void abmTasasVar(WebDriver driver, WebDriverWait wait) throws InterruptedException{    
    
		/*             Acceso al ABM Tasas Variable        */
	    ...
	    waitCuore.repited(driver, wait);
	    wait.until(ExpectedConditions.elementToBeClickable(By.id("menuTasasVariables")));
	    driver.findElement(By.id("menuTasasVariables")).click();
	}
}